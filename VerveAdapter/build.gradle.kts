...
android {
    namespace = "com.chartboost.mediation.verveadapter"
    compileSdk = 33
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "4.3.2.0.0"
...
dependencies {
    ...
    // Partner SDK
    implementation("net.pubnative:hybid.sdk:3.2.0")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                pom {
                    name.set("Chartboost Mediation Adapter Verve")
